...
describe("selectActiveWeek", () => {
  ...
  it("recency treats non-finite season_year and week_number as 0 so leftover drafts cannot hide newer weeks", () => {
    ...
    assert.equal(selectActiveWeek([onlyCompression]), null);
    assert.equal(selectActiveWeek([onlyEmptyCompression]), null);
    assert.equal(familyWeekChrome("The Harper House", onlyCompression), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", onlyEmptyCompression), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyCompression),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyCompression),
    ...
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyCompression),
      "The Harper House · Week 0",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyCompression),
    ...
    assert.equal(selectActiveWeek([onlyDecompression]), null);
    assert.equal(selectActiveWeek([onlyEmptyDecompression]), null);
    assert.equal(familyWeekChrome("The Harper House", onlyDecompression), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", onlyEmptyDecompression), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyDecompression),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyDecompression),
    ...
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyDecompression),
      "The Harper House · Week 0",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyDecompression),
    ...
    assert.equal(selectActiveWeek([onlyTextEncoder]), null);
    assert.equal(selectActiveWeek([onlyEmptyTextEncoder]), null);
    assert.equal(familyWeekChrome("The Harper House", onlyTextEncoder), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", onlyEmptyTextEncoder), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyTextEncoder),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyTextEncoder),
    ...
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyTextEncoder),
      "The Harper House · Week 0",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", onlyEmptyTextEncoder),
  ...
  it("leftover compression stream keys cannot hide a newer week (a–e)", () => {
    ...
    assert.equal(selectActiveWeek([compressionKeys, w(1, "draft"), w(2, "final")])?.week_number, 2);
    assert.equal(
      selectActiveWeek([w(1, "draft"), compressionLocked, w(2, "final")])?.status,
      "final",
    );
    assert.equal(
      selectActiveWeek([w(2, "final"), w(1, "draft"), emptyCompression])?.week_number,
      2,
    );
    assert.equal(selectActiveWeek([mixed, w(1, "draft"), w(2, "final")])?.status, "final");
    assert.equal(selectActiveWeek([mixedWeek, w(1, "draft"), w(2, "final")])?.week_number, 2);
    ...
    assert.equal(selectActiveWeek([compressionKeys]), null);
    assert.equal(selectActiveWeek([compressionLocked, emptyCompression, mixed]), null);
    assert.equal(selectActiveWeek([mixedWeek]), null);
    assert.doesNotThrow(() =>
      selectActiveWeek([compressionKeys, w(1, "draft"), w(2, "final")]),
    );
    assert.doesNotThrow(() => selectActiveWeek([compressionLocked, w(2, "final")]));
    assert.doesNotThrow(() => recency(compressionKeys, w(2, "final")));
    assert.doesNotThrow(() => recency(compressionLocked, w(2, "final")));
    assert.doesNotThrow(() => recency(emptyCompression, w(2, "final")));
    assert.doesNotThrow(() => recency(mixed, w(2, "final")));
    assert.doesNotThrow(() => recency(mixedWeek, w(2, "final")));
    assert.doesNotThrow(() => nextWeekSlot(compressionKeys));
    assert.doesNotThrow(() => nextWeekSlot(compressionLocked));
    assert.deepEqual(nextWeekSlot(compressionKeys), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(compressionLocked), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(emptyCompression), { season_year: 0, week_number: 1 });
    // leftover compression stream keys must not beat a same-recency leftover draft
    const leftoverMissingDraft = { status: "draft" } as never;
    assert.equal(selectActiveWeek([compressionKeys, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([leftoverMissingDraft, compressionLocked])?.status, "draft");
    assert.equal(selectActiveWeek([mixed, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([emptyCompression, leftoverMissingDraft])?.status, "draft");
    assert.ok(recency(compressionKeys, w(2, "final")) > 0);
    assert.ok(recency(compressionLocked, w(2, "final")) > 0);
    assert.ok(recency(emptyCompression, w(2, "final")) > 0);
    assert.ok(recency(mixed, w(2, "final")) > 0);
    assert.ok(recency(mixedWeek, w(2, "final")) > 0);
    ...
    assert.equal(b?.id, "52a42a9e");
    assert.equal(b?.status, "open");
    assert.equal(selectActiveWeek([leftover, compressionLocked, open])?.week_number, 2);
    assert.equal(selectActiveWeek([open, leftover, emptyCompression])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixed, leftover, open])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixedWeek, leftover, open])?.id, "52a42a9e");
    assert.equal(weekSwitcherLabel(open, b), "This Sunday");
    assert.equal(weekSwitcherLabel(leftover, b), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", b), "The Harper House · Week 2");
    assert.equal(pickViewWeek([leftover, open], b, "next")?.id, "52a42a9e");
    assert.equal([compressionKeys, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([compressionLocked, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([emptyCompression, leftover, open].sort(recency)[0]?.week_number, 2);
    ...
    assert.equal(weekSwitcherLabel(nextDraft, c), "Next week");
    assert.equal(pickViewWeek([thisSunday, nextDraft], c, "next")?.id, "w2");
    assert.equal(selectActiveWeek([compressionLocked, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([emptyCompression, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixed, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixedWeek, thisSunday, nextDraft])?.id, "w1");
    ...
    assert.equal(selectActiveWeek([mixed, w(1, "final")])?.status, "final");
    assert.equal(selectActiveWeek([compressionKeys, compressionLocked]), null);
    assert.equal(selectActiveWeek(null), null);
    assert.equal(selectActiveWeek(undefined), null);
    ...
    assert.equal(e?.id, "w2d");
    assert.equal(e?.status, "open");
    assert.equal(selectActiveWeek([skipped, compressionLocked, dirty])?.week_number, 2);
    assert.equal(selectActiveWeek([dirty, skipped, emptyCompression])?.id, "w2d");
    assert.equal(selectActiveWeek([mixed, skipped, dirty])?.id, "w2d");
    assert.equal(selectActiveWeek([mixedWeek, skipped, dirty])?.id, "w2d");
    assert.equal(weekSwitcherLabel(dirty, e), "This Sunday");
    assert.equal(weekSwitcherLabel(skipped, e), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", e), "The Harper House · Week 2");
    assert.equal(pickViewWeek([skipped, dirty], e, "next")?.id, "w2d");
    assert.equal([compressionKeys, skipped, dirty].sort(recency)[0]?.week_number, 2);
    assert.equal(familyWeekChrome("The Harper House", compressionKeys), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", compressionLocked), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", emptyCompression), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", compressionKeys),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", compressionKeys),
    ...
    assert.doesNotThrow(() => weekSwitcherLabel(compressionKeys, e));
  });
  ...
  it("leftover decompression stream keys cannot hide a newer week (a–e)", () => {
    ...
    assert.equal(selectActiveWeek([decompressionKeys, w(1, "draft"), w(2, "final")])?.week_number, 2);
    assert.equal(
      selectActiveWeek([w(1, "draft"), decompressionLocked, w(2, "final")])?.status,
      "final",
    );
    assert.equal(
      selectActiveWeek([w(2, "final"), w(1, "draft"), emptyDecompression])?.week_number,
      2,
    );
    assert.equal(selectActiveWeek([mixed, w(1, "draft"), w(2, "final")])?.status, "final");
    assert.equal(selectActiveWeek([mixedWeek, w(1, "draft"), w(2, "final")])?.week_number, 2);
    ...
    assert.equal(selectActiveWeek([decompressionKeys]), null);
    assert.equal(selectActiveWeek([decompressionLocked, emptyDecompression, mixed]), null);
    assert.equal(selectActiveWeek([mixedWeek]), null);
    assert.doesNotThrow(() =>
      selectActiveWeek([decompressionKeys, w(1, "draft"), w(2, "final")]),
    );
    assert.doesNotThrow(() => selectActiveWeek([decompressionLocked, w(2, "final")]));
    assert.doesNotThrow(() => recency(decompressionKeys, w(2, "final")));
    assert.doesNotThrow(() => recency(decompressionLocked, w(2, "final")));
    assert.doesNotThrow(() => recency(emptyDecompression, w(2, "final")));
    assert.doesNotThrow(() => recency(mixed, w(2, "final")));
    assert.doesNotThrow(() => recency(mixedWeek, w(2, "final")));
    assert.doesNotThrow(() => nextWeekSlot(decompressionKeys));
    assert.doesNotThrow(() => nextWeekSlot(decompressionLocked));
    assert.deepEqual(nextWeekSlot(decompressionKeys), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(decompressionLocked), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(emptyDecompression), { season_year: 0, week_number: 1 });
    // leftover decompression stream keys must not beat a same-recency leftover draft
    const leftoverMissingDraft = { status: "draft" } as never;
    assert.equal(selectActiveWeek([decompressionKeys, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([leftoverMissingDraft, decompressionLocked])?.status, "draft");
    assert.equal(selectActiveWeek([mixed, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([emptyDecompression, leftoverMissingDraft])?.status, "draft");
    assert.ok(recency(decompressionKeys, w(2, "final")) > 0);
    assert.ok(recency(decompressionLocked, w(2, "final")) > 0);
    assert.ok(recency(emptyDecompression, w(2, "final")) > 0);
    assert.ok(recency(mixed, w(2, "final")) > 0);
    assert.ok(recency(mixedWeek, w(2, "final")) > 0);
    ...
    assert.equal(b?.id, "52a42a9e");
    assert.equal(b?.status, "open");
    assert.equal(selectActiveWeek([leftover, decompressionLocked, open])?.week_number, 2);
    assert.equal(selectActiveWeek([open, leftover, emptyDecompression])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixed, leftover, open])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixedWeek, leftover, open])?.id, "52a42a9e");
    assert.equal(weekSwitcherLabel(open, b), "This Sunday");
    assert.equal(weekSwitcherLabel(leftover, b), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", b), "The Harper House · Week 2");
    assert.equal(pickViewWeek([leftover, open], b, "next")?.id, "52a42a9e");
    assert.equal([decompressionKeys, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([decompressionLocked, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([emptyDecompression, leftover, open].sort(recency)[0]?.week_number, 2);
    ...
    assert.equal(weekSwitcherLabel(nextDraft, c), "Next week");
    assert.equal(pickViewWeek([thisSunday, nextDraft], c, "next")?.id, "w2");
    assert.equal(selectActiveWeek([decompressionLocked, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([emptyDecompression, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixed, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixedWeek, thisSunday, nextDraft])?.id, "w1");
    ...
    assert.equal(selectActiveWeek([mixed, w(1, "final")])?.status, "final");
    assert.equal(selectActiveWeek([decompressionKeys, decompressionLocked]), null);
    assert.equal(selectActiveWeek(null), null);
    assert.equal(selectActiveWeek(undefined), null);
    ...
    assert.equal(e?.id, "w2d");
    assert.equal(e?.status, "open");
    assert.equal(selectActiveWeek([skipped, decompressionLocked, dirty])?.week_number, 2);
    assert.equal(selectActiveWeek([dirty, skipped, emptyDecompression])?.id, "w2d");
    assert.equal(selectActiveWeek([mixed, skipped, dirty])?.id, "w2d");
    assert.equal(selectActiveWeek([mixedWeek, skipped, dirty])?.id, "w2d");
    assert.equal(weekSwitcherLabel(dirty, e), "This Sunday");
    assert.equal(weekSwitcherLabel(skipped, e), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", e), "The Harper House · Week 2");
    assert.equal(pickViewWeek([skipped, dirty], e, "next")?.id, "w2d");
    assert.equal([decompressionKeys, skipped, dirty].sort(recency)[0]?.week_number, 2);
    assert.equal(familyWeekChrome("The Harper House", decompressionKeys), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", decompressionLocked), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", emptyDecompression), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", decompressionKeys),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", decompressionKeys),
    ...
    assert.doesNotThrow(() => weekSwitcherLabel(decompressionKeys, e));
  });
  ...
  it("leftover text encoder stream keys cannot hide a newer week (a–e)", () => {
    ...
    assert.equal(selectActiveWeek([textEncoderKeys, w(1, "draft"), w(2, "final")])?.week_number, 2);
    assert.equal(
      selectActiveWeek([w(1, "draft"), textEncoderLocked, w(2, "final")])?.status,
      "final",
    );
    assert.equal(
      selectActiveWeek([w(2, "final"), w(1, "draft"), emptyTextEncoder])?.week_number,
      2,
    );
    assert.equal(selectActiveWeek([mixed, w(1, "draft"), w(2, "final")])?.status, "final");
    assert.equal(selectActiveWeek([mixedWeek, w(1, "draft"), w(2, "final")])?.week_number, 2);
    ...
    assert.equal(selectActiveWeek([textEncoderKeys]), null);
    assert.equal(selectActiveWeek([textEncoderLocked, emptyTextEncoder, mixed]), null);
    assert.equal(selectActiveWeek([mixedWeek]), null);
    assert.doesNotThrow(() =>
      selectActiveWeek([textEncoderKeys, w(1, "draft"), w(2, "final")]),
    );
    assert.doesNotThrow(() => selectActiveWeek([textEncoderLocked, w(2, "final")]));
    assert.doesNotThrow(() => recency(textEncoderKeys, w(2, "final")));
    assert.doesNotThrow(() => recency(textEncoderLocked, w(2, "final")));
    assert.doesNotThrow(() => recency(emptyTextEncoder, w(2, "final")));
    assert.doesNotThrow(() => recency(mixed, w(2, "final")));
    assert.doesNotThrow(() => recency(mixedWeek, w(2, "final")));
    assert.doesNotThrow(() => nextWeekSlot(textEncoderKeys));
    assert.doesNotThrow(() => nextWeekSlot(textEncoderLocked));
    assert.deepEqual(nextWeekSlot(textEncoderKeys), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(textEncoderLocked), { season_year: 0, week_number: 1 });
    assert.deepEqual(nextWeekSlot(emptyTextEncoder), { season_year: 0, week_number: 1 });
    // leftover text encoder stream keys must not beat a same-recency leftover draft
    const leftoverMissingDraft = { status: "draft" } as never;
    assert.equal(selectActiveWeek([textEncoderKeys, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([leftoverMissingDraft, textEncoderLocked])?.status, "draft");
    assert.equal(selectActiveWeek([mixed, leftoverMissingDraft])?.status, "draft");
    assert.equal(selectActiveWeek([emptyTextEncoder, leftoverMissingDraft])?.status, "draft");
    assert.ok(recency(textEncoderKeys, w(2, "final")) > 0);
    assert.ok(recency(textEncoderLocked, w(2, "final")) > 0);
    assert.ok(recency(emptyTextEncoder, w(2, "final")) > 0);
    assert.ok(recency(mixed, w(2, "final")) > 0);
    assert.ok(recency(mixedWeek, w(2, "final")) > 0);
    ...
    assert.equal(b?.id, "52a42a9e");
    assert.equal(b?.status, "open");
    assert.equal(selectActiveWeek([leftover, textEncoderLocked, open])?.week_number, 2);
    assert.equal(selectActiveWeek([open, leftover, emptyTextEncoder])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixed, leftover, open])?.id, "52a42a9e");
    assert.equal(selectActiveWeek([mixedWeek, leftover, open])?.id, "52a42a9e");
    assert.equal(weekSwitcherLabel(open, b), "This Sunday");
    assert.equal(weekSwitcherLabel(leftover, b), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", b), "The Harper House · Week 2");
    assert.equal(pickViewWeek([leftover, open], b, "next")?.id, "52a42a9e");
    assert.equal([textEncoderKeys, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([textEncoderLocked, leftover, open].sort(recency)[0]?.week_number, 2);
    assert.equal([emptyTextEncoder, leftover, open].sort(recency)[0]?.week_number, 2);
    ...
    assert.equal(weekSwitcherLabel(nextDraft, c), "Next week");
    assert.equal(pickViewWeek([thisSunday, nextDraft], c, "next")?.id, "w2");
    assert.equal(selectActiveWeek([textEncoderLocked, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([emptyTextEncoder, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixed, thisSunday, nextDraft])?.id, "w1");
    assert.equal(selectActiveWeek([mixedWeek, thisSunday, nextDraft])?.id, "w1");
    ...
    assert.equal(selectActiveWeek([mixed, w(1, "final")])?.status, "final");
    assert.equal(selectActiveWeek([textEncoderKeys, textEncoderLocked]), null);
    assert.equal(selectActiveWeek(null), null);
    assert.equal(selectActiveWeek(undefined), null);
    ...
    assert.equal(e?.id, "w2d");
    assert.equal(e?.status, "open");
    assert.equal(selectActiveWeek([skipped, textEncoderLocked, dirty])?.week_number, 2);
    assert.equal(selectActiveWeek([dirty, skipped, emptyTextEncoder])?.id, "w2d");
    assert.equal(selectActiveWeek([mixed, skipped, dirty])?.id, "w2d");
    assert.equal(selectActiveWeek([mixedWeek, skipped, dirty])?.id, "w2d");
    assert.equal(weekSwitcherLabel(dirty, e), "This Sunday");
    assert.equal(weekSwitcherLabel(skipped, e), "Week 1");
    ...
    assert.equal(familyWeekChrome("The Harper House", e), "The Harper House · Week 2");
    assert.equal(pickViewWeek([skipped, dirty], e, "next")?.id, "w2d");
    assert.equal([textEncoderKeys, skipped, dirty].sort(recency)[0]?.week_number, 2);
    assert.equal(familyWeekChrome("The Harper House", textEncoderKeys), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", textEncoderLocked), "The Harper House");
    assert.equal(familyWeekChrome("The Harper House", emptyTextEncoder), "The Harper House");
    assert.notEqual(
      familyWeekChrome("The Harper House", textEncoderKeys),
      "The Harper House · Week 2",
    );
    assert.notEqual(
      familyWeekChrome("The Harper House", textEncoderKeys),
    ...
    assert.doesNotThrow(() => weekSwitcherLabel(textEncoderKeys, e));
  });
  ...
  it("selectActiveWeek does not rank draft above final as a class", () => {
    ...
    assert.match(body, /leftover compression stream keys cannot hide a newer week/);
    assert.match(body, /leftoverCompressionStreamKey\(week\.season_year\)/);
    assert.match(body, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(body, /leftoverDecompressionStreamKey\(week\.season_year\)/);
    assert.match(body, /leftover text encoder stream keys cannot hide a newer week/);
    assert.match(body, /leftoverTextEncoderStreamKey\(week\.season_year\)/);
    ...
    assert.match(chromeBody, /leftover compression stream keys cannot hide a newer week/);
    assert.match(chromeBody, /leftoverCompressionStreamKey\(weekNumber\)/);
    assert.match(chromeBody, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(chromeBody, /leftoverDecompressionStreamKey\(weekNumber\)/);
    assert.match(chromeBody, /leftover text encoder stream keys cannot hide a newer week/);
    assert.match(chromeBody, /leftoverTextEncoderStreamKey\(weekNumber\)/);
    ...
    assert.match(recencyImpl, /leftover compression stream keys cannot hide a newer week/);
    assert.match(recencyImpl, /leftoverCompressionStreamKey\(aYearKey\)/);
    assert.match(recencyImpl, /leftoverCompressionStreamKey\(bYearKey\)/);
    assert.match(recencyImpl, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(recencyImpl, /leftoverDecompressionStreamKey\(aYearKey\)/);
    assert.match(recencyImpl, /leftoverDecompressionStreamKey\(bYearKey\)/);
    assert.match(recencyImpl, /leftover text encoder stream keys cannot hide a newer week/);
    assert.match(recencyImpl, /leftoverTextEncoderStreamKey\(aYearKey\)/);
    assert.match(recencyImpl, /leftoverTextEncoderStreamKey\(bYearKey\)/);
    ...
    assert.match(nextBody, /leftover compression stream keys cannot hide a newer week/);
    assert.match(nextBody, /leftoverCompressionStreamKey\(week\.season_year\)/);
    assert.match(nextBody, /leftoverCompressionStreamKey\(week\.week_number\)/);
    assert.match(nextBody, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(nextBody, /leftoverDecompressionStreamKey\(week\.season_year\)/);
    assert.match(nextBody, /leftoverDecompressionStreamKey\(week\.week_number\)/);
    assert.match(nextBody, /leftover text encoder stream keys cannot hide a newer week/);
    assert.match(nextBody, /leftoverTextEncoderStreamKey\(week\.season_year\)/);
    assert.match(nextBody, /leftoverTextEncoderStreamKey\(week\.week_number\)/);
    ...
    assert.match(labelBody, /leftover compression stream keys cannot hide a newer week/);
    assert.match(labelBody, /leftoverCompressionStreamKey\(weekNumber\)/);
    assert.match(labelBody, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(labelBody, /leftoverDecompressionStreamKey\(weekNumber\)/);
    assert.match(labelBody, /leftover text encoder stream keys cannot hide a newer week/);
    assert.match(labelBody, /leftoverTextEncoderStreamKey\(weekNumber\)/);
...
describe("useCurrentWeek production wiring", () => {
  it("db.ts selects the active week through selectActiveWeek, not LIMIT 1", () => {
    ...
    assert.match(fetchBody, /leftover compression stream keys cannot hide a newer week/);
    assert.match(fetchBody, /leftover decompression stream keys cannot hide a newer week/);
    assert.match(fetchBody, /leftover text encoder stream keys cannot hide a newer week/);
